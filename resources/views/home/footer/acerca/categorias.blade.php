...
@section('contenido')
    <main class="max-w-6xl mx-auto p-6 bg-gray-100 rounded-lg shadow-lg">
        <div class="mb-10">
            <h2 class="text-3xl font-bold text-gray-800 mb-4">Categorías de Usuario en GameTex</h2>
            <p class="text-gray-600 leading-relaxed">
                En GameTex, reconocemos y valoramos el compromiso y la dedicación de nuestros jugadores. Para ello, hemos
                implementado un sistema de categorías que clasifica a los usuarios en función de su experiencia y logros en
                la plataforma. Las categorías son: Principiante, Veterano, Leyenda y Campeón. A continuación, te explicamos
                cada categoría, sus beneficios y los requisitos necesarios para alcanzarlas.
            </p>
        </div>
        ...
        <article class="space-y-8">
            ...
            <div class="bg-white rounded-lg p-6 shadow-md">
                <h3 class="text-2xl font-semibold text-gray-700 mb-4">1. Categoría: Principiante</h3>
                <div class="mb-4">
                    <h4 class="text-lg font-medium text-gray-600">Beneficios:</h4>
                    <ul class="list-disc list-inside text-gray-500 ml-5">
                ...
                <div>
                    <h4 class="text-lg font-medium text-gray-600">Requisitos:</h4>
                    <ul class="list-disc list-inside text-gray-500 ml-5">
            ...
            <!-- Categoría Veterano -->
            <div class="bg-white rounded-lg p-6 shadow-md">
                <h3 class="text-2xl font-semibold text-gray-700 mb-4">2. Categoría: Veterano</h3>
                <div class="mb-4">
                    <h4 class="text-lg font-medium text-gray-600">Beneficios:</h4>
                    <ul class="list-disc list-inside text-gray-500 ml-5">
            ...
            <!-- Categoría Leyenda -->
            <div class="bg-white rounded-lg p-6 shadow-md">
                <h3 class="text-2xl font-semibold text-gray-700 mb-4">3. Categoría: Leyenda</h3>
                <div class="mb-4">
                    <h4 class="text-lg font-medium text-gray-600">Beneficios:</h4>
                    <ul class="list-disc list-inside text-gray-500 ml-5">
            ...
            <!-- Categoría Campeón -->
            <div class="bg-white rounded-lg p-6 shadow-md">
                <h3 class="text-2xl font-semibold text-gray-700 mb-4">4. Categoría: Campeón</h3>
                <div class="mb-4">
                    <h4 class="text-lg font-medium text-gray-600">Beneficios:</h4>
                    <ul class="list-disc list-inside text-gray-500 ml-5">
