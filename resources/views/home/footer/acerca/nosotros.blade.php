...
@section('contenido')
    <main class="max-w-6xl mx-auto p-6 bg-gray-100 rounded-lg shadow-lg">
        <div class="mb-10">
            <h2 class="text-3xl font-bold text-gray-800 mb-4">Acerca de GameTex: Donde los Gamers Compiten y Ganan
                Recompensas</h2>
            <p class="text-gray-600 leading-relaxed">
                ...
                dedicación. En Gametex, cada partida importa, y cada victoria te acerca un paso más a obtener premios
                reales.
            </p>
        </div>
        ...
        <article class="space-y-8">
            ...
            <div class="bg-white rounded-lg p-6 shadow-md">
                <h3 class="text-2xl font-semibold text-gray-700 mb-4">¿Quiénes somos?</h3>
            ...
            <!-- Nuestra misión -->
            <div class="bg-white rounded-lg p-6 shadow-md">
                <h3 class="text-2xl font-semibold text-gray-700 mb-4">Nuestra misión: Competencia justa y gratificante</h3>
                <p class="text-gray-600">
            ...
            <!-- Visión -->
            <div class="bg-white rounded-lg p-6 shadow-md">
                <h3 class="text-2xl font-semibold text-gray-700 mb-4">Nuestra visión: Construir la comunidad de gamers más
                    grande y unida</h3>
                <p class="text-gray-600">
            ...
            <div class="bg-white rounded-lg p-6 shadow-md">
                <h3 class="text-2xl font-semibold text-gray-700 mb-4">Torneos para todos los niveles</h3>
                <p class="text-gray-600">
            ...
            <!-- Recompensas -->
            <div class="bg-white rounded-lg p-6 shadow-md">
                <h3 class="text-2xl font-semibold text-gray-700 mb-4">Recompensas que hacen la diferencia</h3>
                <p class="text-gray-600">
            ...
            <div class="bg-white rounded-lg p-6 shadow-md">
                <h3 class="text-2xl font-semibold text-gray-700 mb-4">Seguridad y juego justo</h3>
                <p class="text-gray-600">
            ...
            <!-- Únete a Gametex -->
            <div class="bg-white rounded-lg p-6 shadow-md">
                <h3 class="text-2xl font-semibold text-gray-700 mb-4">Únete a Gametex:</h3>
                <p class="text-gray-600">
