    ...
    <section id="24h">
        ...
        <div>
            ...
            <div
                class="p-3 my-3 flex items-center justify-start bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600 grid-cols-2">
                <div class="w-[5%] hidden sm:block">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTagbbVn8g0ILDayKjIp6_KAONYVp7_VkakLQ&s" alt="Imagen del jugador" class="rounded-lg">
                </div>
                <!-- Información del jugador -->
                <div class="ml-4">
                    <dt class="font-semibold text-gray-900 dark:text-white">Lluvia de amburguesas</dt>
                </div>
                <button type="button" data-drawer-target="drawer-read-product-advanced"
                    data-drawer-show="drawer-read-product-advanced" aria-controls="drawer-read-product-advanced"
                    class="py-[5px] px-3  ml-auto flex items-center text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-900 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-900 dark:focus:ring-gray-900 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-600">
            ...
            <div
                class="p-3 my-3 flex items-center justify-start bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600 grid-cols-2">
                <div class="w-[5%] hidden sm:block">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzJjLneDX5JaeR1aDrBHBVFttNsmaMGedAJQ&s" alt="Imagen del jugador" class="rounded-lg">
                </div>
                <!-- Información del jugador -->
                <div class="ml-4">
                    <dt class="font-semibold text-gray-900 dark:text-white">Chcicharron asado</dt>
                </div>
                <button type="button" data-drawer-target="drawer-read-product-advanced"
                    data-drawer-show="drawer-read-product-advanced" aria-controls="drawer-read-product-advanced"
                    class="py-[5px] px-3  ml-auto flex items-center text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-900 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-900 dark:focus:ring-gray-900 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-600">
            ...
            <div
                class="p-3 my-3 flex items-center justify-start bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600 grid-cols-2">
                <div class="w-[5%] hidden sm:block">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsBXwm9IyKMOdoAlRGepI9wTwclCdX6lpw3w&s" alt="Imagen del jugador" class="rounded-lg">
                </div>
                <!-- Información del jugador -->
                <div class="ml-4">
                    <dt class="font-semibold text-gray-900 dark:text-white">Miguel Pedro Flores</dt>
                </div>
                <button type="button" data-drawer-target="drawer-read-product-advanced"
                    data-drawer-show="drawer-read-product-advanced" aria-controls="drawer-read-product-advanced"
                    class="py-[5px] px-3  ml-auto flex items-center text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-900 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-900 dark:focus:ring-gray-900 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-600">
