<!-- resources/views/components/asignar-modal.blade.php -->
<div id="asignarModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-900 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="asignarModal">
            ...
            <form id="asignarForm" action="{{ route('admin.crud.asignar') }}" method="POST">
                @csrf
                <input type="hidden" name="recompensa_id" id="recompensa_id">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        <label for="tipo_busqueda"
